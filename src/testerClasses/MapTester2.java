...
public class MapTester2 {
	...
	public static void main(String[] args) {
		BSTMap<Integer, String> map = new BSTMap<Integer, String>(new NumberComparator1()); 
		mapInsert(1, "one", map); 
		...
		showMapKeys("Keys of the Map are the following", map);
		showMapValues("Values of the map are the following", map);
	}
